        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column fs-5 pt-lg-5 my-5 ps-lg-3">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="http://localhost:8012/blog/?url=/pages/categories">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <?php if (isset($_SESSION['post']['categoryID'])) { ?>
                        <?php
                        if (session_id() == '') {
                            session_start();
                        }
                                    ...
                                    if (sizeof($posts) > 0) {
                                        foreach ($posts as $post) : ?>
                                            <article class="blog-post my-5 cardcolor">
                                                ...
                                                <?php
                                                $authors = getPostByID($post['postID']);
                                                foreach ($authors as $author) : ?>
                                                    <p class="blog-post-meta"><?php echo 'Date:&nbsp;' . $post['createdAt'] . '&nbsp;&nbsp; by: &nbsp;' ?><a href="#"><?php echo $author['username'] ?></a></p>
                    ...
                    <?php } else {
                        header("location: http://localhost:8012/blog/?url=/pages/categories");
                    } ?>
                </main>
            </div>
        </div>
